...
echo %_startFile%| findstr /iec:"1cv8.exe"""
if errorlevel 1 (
...
echo %_updateFile%| findstr /iec:".cfu"""
if errorlevel 1 (
...
start "Обновление конфигурации" /b /wait %_startFile% DESIGNER /DisableStartupDialogs /F %_basePath% /WA- /UCКодРазрешения /UpdateCfg %_updateFile% /UpdateDBCfg -Dynamic- / -WarningsAsErrors /Out%_logPath% -NoTruncate
if errorlevel 1 (
